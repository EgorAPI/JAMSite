        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                    ...
                    <img
                        ...
                        alt="Производство наружной рекламы в рекламном агентстве «Джем»"
                        class="about-image"
                        loading="lazy"
                    >
                </div>
            ...
            <div class="col-lg-6">
                ...
                <p class="mb-0">
                    Рекламное агентство «Джем» занимается изготовлением наружной рекламы в Абакане
                    и работает с проектами в Республике Хакасия и на юге Красноярского края.
                    Собственная производственная база позволяет выполнять изготовление рекламных
                    конструкций, вывесок, баннеров и других видов рекламной продукции.
                </p>
            </div>
        </div>
    </div>
